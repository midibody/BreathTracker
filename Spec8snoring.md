...
This device includes an autonomous snoring detection system based on a digital PDM microphone and motion sensing.
...
Intended behavior during sleep

In normal operation:

Occasional isolated noises are ignored

Short movements temporarily suppress detection

Sustained, repetitive snoring while the body is still leads to vibration feedback

The vibration is designed to be just strong enough to provoke a micro-movement or posture change without fully waking the user.
